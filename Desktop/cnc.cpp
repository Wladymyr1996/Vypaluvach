...
CNC::CNC(QWidget *parent) : QObject(parent)
{
    myParent = parent;
        ...
        if ((data.at(i) == msgEnd) && (yps!=NULL)) {
            ...
            if ((!yps->empty())) {
                ...
                if (status==Printing) {
                    ...
                    setHeadOff();
                    setBuzzerOn();
                    QMessageBox::information(myParent, tr("Information - Vypaluvach"), tr("Printing was succesfully end!"), QMessageBox::Ok);
                    setBuzzerOff();
                    setGetPos();
                    HeadTimer->start(5000);
                }
                if (status==Stoped) {
                    ...
                    setHeadOff();
                    setBuzzerOn();
                    QMessageBox::information(myParent, tr("Information - Vypaluvach"), tr("Printing was stoped!"), QMessageBox::Ok);
                    setBuzzerOff();
                    setGetPos();
                }
            }
